...
function Resume() {
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button
        href="/steve_delarosa_resume.pdf"
        variant="secondary"
  ...
  return (
    <>
      <Container className="mt-9">
        <div className="max-w-2xl pb-30">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
            Software Engineer
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I’m Steve, a software engineer based in Florida. I specialize in
            building modern, user-friendly web applications with a strong focus
            on frontend development. With experience across the full stack, I
            bring ideas to life—from design to deployment. I’m passionate about
            creating tech that solves real problems and inspires people to
      ...
      <Container className="pt-40 md:mt-28">
        <Projects />
        <SimpleLayout
        ...
        />
        <div className="mx-auto mt-20 max-w-[820px] gap-10">
          <Resume />
        </div>
      </Container>
    </>
